// partner-portal/src/components/partner/PartnerDashboardLayout.tsx
'use client';

import React, { ReactNode, useState } from 'react';
import Link from 'next/link';
import { usePathname, useRouter } from 'next/navigation';
import { LayoutDashboard, KeyRound, DollarSign, Cloud, FileText, FileStack, Menu, Bell, UserCircle, LogOut } from 'lucide-react';
