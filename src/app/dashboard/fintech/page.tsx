  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Fintech Backend Dashboard</h1>
          <p className="text-gray-600">Manage users, wallets, transactions, and KYC</p>
        </div>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                >
                  ...
                  <path d="m22 21-2-2m0 0a4 4 0 0 0-4-4H14a4 4 0 0 0-4 4v2" />
                </svg>
              </CardHeader>
              <CardContent>
