...
>(
  (
    ...
    return (
      <aside
        ref={ref}
        className={cn("group hidden md:flex md:flex-col text-foreground transition-all duration-300 ease-in-out",
