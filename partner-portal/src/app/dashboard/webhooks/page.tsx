// partner-portal/src/app/dashboard/webhooks/page.tsx
'use client';
...
const getWebhookLogsFn = httpsCallable(functions, 'partner-getWebhookLogs');
const resendWebhookFn = httpsCallable(functions, 'partner-resendWebhook');
const getPartnerConfigFn = httpsCallable(functions, 'partner-getApiCredentials');
        ...
        <Card className="bg-gray-800 border border-gray-700 text-white shadow-lg">
            ...
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-2.5 rounded-md transition-all duration-200" disabled={mutation.isPending}>
                                    ...
                                    <tr key={log.id} className="hover:bg-gray-700 transition-colors duration-150">
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap text-center">
                                            {log.deliveryStatus === 'FAILED' && (
                                                <Button size="sm" variant="outline" className="bg-gray-700 border-gray-600 text-white hover:bg-gray-600 hover:text-white" onClick={() => resendMutation.mutate(log.id)} disabled={resendMutation.isPending}>
